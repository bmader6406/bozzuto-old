module ApplicationHelper
  ...
  def facebook_like_link(url)
    content_tag :div, :class => 'facebook-like' do
      <<-END.html_safe
      <iframe src="//www.facebook.com/plugins/like.php?href=#{CGI::escape(url)}&amp;layout=standard&amp;show_faces=false&amp;width=230&amp;action=like&amp;font=arial&amp;colorscheme=light&amp;height=35" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:230px; height:35px;" allowTransparency="true"></iframe>
      END
    end
  end
  ...
  def google_plus_one_button
    content_for(:end_of_body, '<script type="text/javascript" src="//apis.google.com/js/plusone.js"></script>'.html_safe)
